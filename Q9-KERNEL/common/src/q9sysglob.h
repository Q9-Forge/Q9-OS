...
#define Q9_D_INIT           0x0020  /* Zeiger auf das Init-Konfigurationsmodul [VERIFIZIERT, 2026-08-17 -- move.l A5,(0x20,A6) bei 0x6a06 im Original-Kernel; A5 haelt an dieser Stelle NICHT mehr den Exception-Tabellen-Zeiger von 0x68ec, sondern wurde zwischen 0x6986-0x6a06 auf das per Namenssuche gefundene Init-Modul umgebogen -- Suchmechanismus s. intern dokumentiert] */
...
#define Q9_D_COMPAT         0x002E  /* Kompatibilitaets-Flags (1) [VERIFIZIERT, 2026-08-17 -- kopiert aus Init-Modul-Offset (0x68,A5) bei $6a22 im Original-Kernel, Teil der Init-Modul-Einlese-Sequenz, s. Q9_D_INIT, intern dokumentiert] */
...
#define Q9_D_SYSCONF        0x0038  /* Systemkonfigurations-Flags [VERIFIZIERT, 2026-08-17 -- kopiert aus Init-Modul-Offset (0x7a,A5) bei $6a2e im Original-Kernel, s. Q9_D_INIT; deckt sich mit dem in Q9-Flux/docs/MMU_SSM_WORKFLOW_de.md dokumentierten M$SysConf/SSM_NoProt-Flag] */
...
#define Q9_D_COMPAT2        0x03E0  /* Cache-Kompatibilitaets-/Konfigurationsflags [VERIFIZIERT, 2026-08-17 -- kopiert aus Init-Modul-Offset (0x69,A5) bei $6a28 im Original-Kernel, s. Q9_D_INIT */
