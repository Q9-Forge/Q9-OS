...
/* Nur bei TrapLib (Kapitel 5 "User Trap Handlers", 68k_tech.pdf S. 32f
 * -- Tabelle "Additional Header Fields", Zeile "Trap Handlers"):
 * M$IData/M$IRefs (Program+TrapLib gemeinsam) liegen dazwischen bei
 * $40/$44, hier bewusst nicht aufgenommen (fuer F$TLink nicht
 * gebraucht). */
#define Q9_MH68K_INIT       0x48  /* 4 Byte, Trap-Initialisierungs-Einsprung (M$Init) [HANDBUCH, Kapitel 5] */
#define Q9_MH68K_TERM       0x4C  /* 4 Byte, Trap-Terminierungs-Einsprung (M$Term) -- laut Handbuch (Stand V2.4) vom Kernel NIE aufgerufen [HANDBUCH, Kapitel 5] */
