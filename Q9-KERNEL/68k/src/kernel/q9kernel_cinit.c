...
extern void   Q9K_SysDExit(void);     /* q9kernel_entry.a, F$DExit handler */
extern void   Q9K_SysDExitImpl(void); /* q9kernel_procend.c, F$DExit bridge */
extern void   Q9K_SysDExec(void);     /* q9kernel_entry.a, F$DExec handler */
extern void   Q9K_SysDExecImpl(void); /* q9kernel_firstproc.c, F$DExec bridge */
        ...
        if (initMod != 0) {
            ...
            if (initAvailableLen >= 0x7C) {
                ...
                Q9K_ModDirPopulateFromBootList((const Q9_u8 *)Q9K_BOOTLIST_ADDR);
                {
                    ...
                    Q9K_PutU32(usrdisBase + 0x24UL * 4UL, (Q9_u32)(unsigned long)Q9K_SysDExit);
                    Q9K_PutU32(usrdisBase + 0x23UL * 4UL, (Q9_u32)(unsigned long)Q9K_SysDExec);
                    ...
                    Q9K_PutU32(usrdisBase + 0x52UL * 4UL, (Q9_u32)(unsigned long)Q9K_SysFSysDbg);
                    ...
                    Q9K_PutU32(sysdisBase + 0x24UL * 4UL, (Q9_u32)(unsigned long)Q9K_SysDExit);
                    Q9K_PutU32(sysdisBase + 0x23UL * 4UL, (Q9_u32)(unsigned long)Q9K_SysDExec);
                    ...
                    Q9K_PutU32(sysdisBase + 0x52UL * 4UL, (Q9_u32)(unsigned long)Q9K_SysFSysDbg);
