...
| Register-/Pfadadapter für I$-Handler | 🟡 | Open/Read/Close-Dispatcher und Assembly-Schatteneinträge sind Q9-toolchain-kompiliert/verlinkt; Hosttests prüfen Ergebnis-/Carry-Mapping, Open→`E$MNF`, fehlenden Manager sowie `I$Read`-Kurzlesung und Ablehnung eines Backend-Zählers oberhalb der Anforderung; Emulator belegt Open-Aufruf/Rückkehr, Read/Close-Runtime und Read-Buffer-Speicherschutz fehlen; Pfadresolver begrenzt Scan auf 256 Byte, kann ungültige Zeiger nicht abfangen |
