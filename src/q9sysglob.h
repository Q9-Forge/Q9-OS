...
#define Q9_D_BOOTFLAGS      0x093C  /* NEU GEFUNDEN 2026-08-17 [VERIFIZIERT] -- Boot-Zeit-Flags, komplettes Register D3 bei $681e in dker030s hierher gesichert (fuenftes Boot-Register neben D0/D1/A1/A5, s. Thema 01). Bit 4 (bei $67a0, ganz am Kernel-Einsprung geprueft): wenn gesetzt, ueberspringt der Kernel das eigene Interrupt-Maskieren (ori #$700,SR) -- Aufrufer hat es vermutlich schon erledigt. Bit 3 (bei $69dc, waehrend der Init-Modul-Suche geprueft): wenn gesetzt, ueberspringt den Namensvergleich fuer den aktuellen Kandidaten und springt direkt zum "gefunden"-Pfad -- genaue Bedeutung (z.B. "Init-Modul-Adresse vom Bootloader schon bekannt") nicht abschliessend verifiziert. D3 wird spaeter in derselben Funktion mehrfach als gewoehnliches Scratch-Register wiederverwendet (ab $698a) -- die Flags-Bedeutung gilt nur bis dahin. */
