// rbf_ParseHeaderSetEntryAnalyze.java
// Parses the OS-9000/x86 module header of vendor-live/rbf (same mh_com
// layout as kernel/ioman, see FINDINGS.md Fund 1), sets the entry point
// from m_exec (header offset 0x24), and runs full auto-analysis.
...
public class rbf_ParseHeaderSetEntryAnalyze extends GhidraScript {
    @Override
    public void run() throws Exception {
        ...
        disassemble(entry);
        createFunction(entry, "Q9X_rbf_entry_raw");
